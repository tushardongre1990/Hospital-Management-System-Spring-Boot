...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="/doctors" class="appointment-btn scrollto"><span class="d-none d-md-inline">Show</span> Doctors</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/doctors/saddoc.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Osama Sad</h4>
                <span>Chief Medical Officer</span>
                <p>managing the <b>Broken heart</b> department to provide safe and effective medical services.</p>
                <div class="social">
