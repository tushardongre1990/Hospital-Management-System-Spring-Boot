		...
		<form:form action="/edit/${appointment.getId()}" method="put" modelAttribute="appiontment">
			...
			<div class="card text-center" style="width: 18rem;">
			  <div class="card-body">
			    ...
			    <input class="btn btn-primary" name="date" value="2023-07-10 08:00" type="submit">
			  </div>
			</div>
			...
			<div class="card text-center mt-4" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Monday</h5>
			    <input class="btn btn-primary" name="date" value="2023-07-10 10:00" type="submit">
			  </div>
			</div>
			</div>
			<div class="col">
			<div class="card text-center" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Monday</h5>
			    <input class="btn btn-primary" name="date" value="2023-07-10 12:00" type="submit">
			  </div>
			</div>
			...
			<div class="card text-center mt-4" style="width: 18rem;">
			  <div class="card-body">
			    ...
			    <input class="btn btn-primary" name="date" value="2023-08-10 09:00" type="submit">
			  </div>
			</div>
			</div>
			<div class="col">
			<div class="card text-center" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Tuesday</h5>
			    <input class="btn btn-primary" name="date" value="2023-08-10 07:00" type="submit">
			  </div>
			</div>
			<div class="card text-center mt-4" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title">Tuesday</h5>
			    <input class="btn btn-primary"  name="date" value="2023-08-10 06:00" type="submit">
			  </div>
			  </div>
			</div>
			</div>
